...
import { BellAlertIcon, CalendarDaysIcon, HomeIcon } from "react-native-heroicons/outline";
      ...
      <TailwindProvider>
        ...
        {user ? <Tab.Navigator>
          ...
          <Tab.Screen
            ...
            headerShown: false,
            tabBarIcon: ({ color }) => (
              <CalendarDaysIcon color={color} size={24} />
            ),
            }} />
          <Tab.Screen
            name="Notifications"
            ...
            headerShown: false,
            tabBarIcon: ({ color }) => (
              <BellAlertIcon color={color} size={24} />
            ),
            }} />
          <Tab.Screen
            name="Profile"
