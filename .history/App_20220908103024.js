  ...
  const ProfileStackScreen = () => {
    return (
      <ProfileStack.Navigator>
        <ProfileStack.Screen name="Worker Profile" component={ProfileScreen} options={{ headerLargeTitle: false, }} />
      </ProfileStack.Navigator>
    );
  };
          ...
          {user ? <Tab.Navigator>
            ...
            <Tab.Screen
              ...
              component={SchedulesStackScreen} options={{
                ...
                headerShown: false,
                tabBarIcon: ({ color }) => (
                  <CalendarDaysIcon color={color} size={34} />
                ),
              }} />
            <Tab.Screen
              name="Notifs"
              component={NotificationsStackScreen} options={{
                ...
                headerShown: false,
                tabBarIcon: ({ color }) => (
                  <BellAlertIcon color={color} size={34} />
                ),
              }} />
            <Tab.Screen
              name="Profile"
              component={ProfileStackScreen} options={{
                ...
                headerShown: false,
                tabBarIcon: ({ color }) => (
                  <UserCircleIcon color={color} size={34} />
                ),
              }} />
          </Tab.Navigator>
            : <AuthStackScreen />}
