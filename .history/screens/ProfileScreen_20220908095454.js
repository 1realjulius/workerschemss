    ...
    <SafeAreaView>
      <ScrollView className='h-full'>
        <View className='flex flex-col'>
          ...
          <View className='p-4'>
            <View>
              <TouchableOpacity  className='my-1 bg-red-200 px-3 py-2 items-center rounded-md'>
                <Text className='text-lg'>Sign Out</Text>
              </TouchableOpacity>
              <TouchableOpacity  className='my-1 bg-red-200 px-3 py-2 items-center rounded-md'>
                <Text className='text-lg'>Sign Out</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={HandleSignOut} className='my-1 bg-red-600 px-3 py-2 items-center rounded-md flex flex-row justify-center space-x-2'>
                <Text className='text-lg'>Sign Out</Text>
                <ArrowRightOnRectangleIcon size={24} style={tw`text-red-200`}/>
              </TouchableOpacity>
            </View>
          </View>
        </View>
