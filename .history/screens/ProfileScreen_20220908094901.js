    ...
    <SafeAreaView>
      <ScrollView className='h-full'>
        <View className='flex flex-col'>
          ...
          <View className='px-4'>
            <View>
              <TouchableOpacity  className='my-4 bg-red-200 px-3 py-2 items-center rounded-md'>
                <Text className='text-lg'>Sign Out</Text>
              </TouchableOpacity>
              <TouchableOpacity  className='my-4 bg-red-200 px-3 py-2 items-center rounded-md'>
                <Text className='text-lg'>Sign Out</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={HandleSignOut} className='my-4 bg-red-200 px-3 py-2 items-center rounded-md'>
                <Text className='text-lg'>Sign Out</Text>
              </TouchableOpacity>
            </View>
          </View>
