...
import { ArrowRightOnRectangleIcon, BriefcaseIcon } from 'react-native-heroicons/outline';
    ...
    <SafeAreaView>
      <ScrollView className='h-full'>
        <View className='flex flex-col'>
          ...
          <View className='p-4'>
            <View>
              <TouchableOpacity  className='my-1 bg-red-200 px-3 py-2 items-center rounded-md flex flex-row justify-center space-x-2'>
                <Text className='text-lg'>Edit Personal Details</Text>
              </TouchableOpacity>
              <TouchableOpacity  className='my-1 bg-gray-200 px-3 py-2 items-center rounded-md flex flex-row justify-center space-x-2'>
                <Text className='text-lg'>Edit Work Profile</Text>
                <BriefcaseIcon size={24} style={tw`text-red-600`}/>
              </TouchableOpacity>
