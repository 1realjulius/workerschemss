            ...
            <View className='px-4'>
              ...
              <View className='border-2 border-gray-300 rounded-md divide-y-2 divide-gray-300'>
                <View className='px-4 py-2 flex flex-row items-center justify-between'>
                  ...
                  <Text className='text-lg text-gray-500'>{userDetails.FirstName} {userDetails.LastName}</Text>
                </View>
                <View className='px-4 py-2 flex flex-row items-center justify-between'>
                  <Text className='text-lg'>Email</Text>
                  <Text className='text-lg text-gray-500'>{userDetails.Email}</Text>
                </View>
                <View className='px-4 py-2 flex flex-row items-center justify-between'>
                  <Text className='text-lg'>Phone Number</Text>
                  <Text className='text-lg text-gray-500'>{userDetails.PhoneNumber}</Text>
                </View>
              </View>
            </View>
            :
            <View className='flex flex-row items-center justify-center'>
              <View className='bg-white px-8 py-2 items-center rounded-lg'>
                <Text className='text-lg py-2'>You Are Currently Logged In</Text>
                <View className='flex-row pb-2'>
                  <Text className='text-lg pr-1'>Your Email:</Text>
                  {user.user === null ? <Text className='bg-blue-200 px-2 text-lg'>{user.user}</Text> : <Text className='bg-blue-200 px-2 text-lg'>There is no user</Text>}
                </View>
