                ...
                <View className='p-4'>
                    ...
                    <View className='py-4'>
                        ...
                        <View className="items-center">
                            <View className="border-2 flex relative justify-center items-center w-[164px] h-[164px] border-gray-300 rounded-full my-4">
                                <Image source={require('../../assets/Images/tatoo-2.jpg')} className="absolute w-40 h-40 rounded-full" />
                                {image && (
                                    <Image
                                        source={{ uri: image }}
