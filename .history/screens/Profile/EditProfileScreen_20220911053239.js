                ...
                <View className='p-4'>
                    ...
                    <View className='py-4'>
                        ...
                        <View className="items-center">
                            <View className=" border-2 flex items-center w-[164px] h-[164px] border-gray-300 rounded-full my-4">
                                {image ? <Image source={require('../assets/Images/tatoo-2.jpg')} className=" w-40 h-40 rounded-full" /> : <Image source={{ uri: image }} className=" w-40 h-40 rounded-full" />}
                            </View>
