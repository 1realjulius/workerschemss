...
import { setCurrentUser, selectUser, logout, selectEmail } from '../redux/users/userSlice';
...
const ProfileScreen = () => {
  ...
  console.log("The User ID",user.user);
  console.log("The User Email",userEmail.Email);
