            ...
            >
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View className='flex flex-col items-center justify-center my-10'>
                        ...
                        <View className='p-4'>
                            <TouchableOpacity className='flex flex-row items-center px-4 py-2 rounded-md space-x-2' onPress={handleLogin}>
                                <ArrowLeftIcon size={24} className='text-purple-200'/>
