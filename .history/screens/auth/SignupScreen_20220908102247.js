                    ...
                    <View className='flex flex-col px-6 my-10'>
                        ...
                        <View className='flex flex-colpy-2 space-y-2'>
                            <View className=''>
                                ...
                                <TextInput
                                    className='bg-gray-50 border border-gray-200 rounded-md p-2  h-12 leading-none text-[18px]'
                                    // value={userEmail}
                            ...
                            <View>
                                ...
                                <TextInput
                                    className='bg-gray-50 text-[18px] border border-gray-200 rounded-md p-2  h-12  leading-none'
                                    autoCapitalize="none"
                                    autoCorrect={false}
                                    // value={userPassword}
                        ...
                        <View className='p-2'>
                            <TouchableOpacity className='px-2 py-2 bg-purple-800  rounded-md w-80 items-center' onPress={handleSignUp}>
