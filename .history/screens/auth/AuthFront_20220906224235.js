            ...
            <View className=' items-center'>
                ...
                <View className=''>
                    <View className='flex flex-col items-center space-y-2 py-4'>
                        <TouchableOpacity className='bg-purple-600 w-full h-14 items-center justify-center rounded-xl'>
                            <Text className='text-white text-lg'>Sign Up free</Text>
                        </TouchableOpacity>
                        <TouchableOpacity className='border-2 border-purple-600 w-80 h-14 items-center justify-center rounded-xl'>
                            <Text className='text-white text-lg'>Sign Up free</Text>
                        </TouchableOpacity>
